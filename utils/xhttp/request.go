...
import (
	...
	"github.com/xbaseio/xbase/utils/xhttp/internal"
)
...
// send a http request.
func (r *request) request(method, url string, data any, opts ...*RequestOptions) (*Response, error) {
...
func (r *request) prepare(method, url string, data any, opts ...*RequestOptions) (req *http.Request, err error) {
	var (
		buf     []byte
