...
const (
	defaultUserAgent = "BaseHttpClient"
...
func (c *Client) Upload(url string, files any, data any, opts ...*UploadOptions) (*Response, error) {
	return newUpload(c).request(url, files, data, opts...)
}

// Request send an http request.
func (c *Client) Request(method, url string, data any, opts ...*RequestOptions) (*Response, error) {
	return newRequest(c).request(method, url, data, opts...)
}

// Get Send a http request use get method.
func (c *Client) Get(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodGet, url, data, opts...)
}

// Post Send a http request use post method.
func (c *Client) Post(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodPost, url, data, opts...)
}

// Put Send a http request use put method.
func (c *Client) Put(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodPut, url, data, opts...)
}

// Patch Send a http request use patch method.
func (c *Client) Patch(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodPatch, url, data, opts...)
}

// Delete Send a http request use patch method.
func (c *Client) Delete(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodDelete, url, data, opts...)
}

// Head Send a http request use head method.
func (c *Client) Head(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodHead, url, data, opts...)
}

// Options Send a request use options method.
func (c *Client) Options(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodOptions, url, data, opts...)
}

// Connect Send a request use connect method.
func (c *Client) Connect(url string, data any, opts ...*RequestOptions) (*Response, error) {
	return c.Request(MethodConnect, url, data, opts...)
}

// Trace Send a request use trace method.
func (c *Client) Trace(url string, data any, opts ...*RequestOptions) (*Response, error) {
