...
func streamResponse(ctx context.Context, b *xtelegram.Bot, chatID int64, threadID int64, draftID, fullText string) error {
	...
	for i, chunk := range chunks {
		...
		_, err := b.SendMessageDraft(ctx, &xtelegram.SendMessageDraftParams{
			ChatID:          chatID,
	...
	_, err := b.SendMessage(ctx, &xtelegram.SendMessageParams{
		ChatID:          chatID,
