...
func (b *Bot) SendMessage(ctx context.Context, params *SendMessageParams) (*types.Message, error) {
	mes := &types.Message{}
...
func (b *Bot) ForwardMessage(ctx context.Context, params *ForwardMessageParams) (*types.Message, error) {
...
func (b *Bot) ForwardMessages(ctx context.Context, params *ForwardMessagesParams) ([]types.MessageID, error) {
	var result []types.MessageID
	err := b.rawRequest(ctx, "forwardMessages", params, &result)
	return result, err
}

// CopyMessage https://core.telegram.org/bots/api#copymessage
func (b *Bot) CopyMessage(ctx context.Context, params *CopyMessageParams) (*types.MessageID, error) {
	result := &types.MessageID{}
	err := b.rawRequest(ctx, "copyMessage", params, result)
	return result, err
}

// CopyMessages https://core.telegram.org/bots/api#copymessages
func (b *Bot) CopyMessages(ctx context.Context, params *CopyMessagesParams) ([]types.MessageID, error) {
	var result []types.MessageID
...
func (b *Bot) SendPhoto(ctx context.Context, params *SendPhotoParams) (*types.Message, error) {
	mes := &types.Message{}
...
func (b *Bot) SendAudio(ctx context.Context, params *SendAudioParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendDocument(ctx context.Context, params *SendDocumentParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendVideo(ctx context.Context, params *SendVideoParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendAnimation(ctx context.Context, params *SendAnimationParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendVoice(ctx context.Context, params *SendVoiceParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendVideoNote(ctx context.Context, params *SendVideoNoteParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendPaidMedia(ctx context.Context, params *SendPaidMediaParams) (*types.Message, error) {
...
func (b *Bot) SendMediaGroup(ctx context.Context, params *SendMediaGroupParams) ([]*types.Message, error) {
	var result []*types.Message
...
func (b *Bot) SendLocation(ctx context.Context, params *SendLocationParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) EditMessageLiveLocation(ctx context.Context, params *EditMessageLiveLocationParams) (*types.Message, error) {
	return b.editMethodRequest(ctx, "editMessageLiveLocation", params)
}

// StopMessageLiveLocation https://core.telegram.org/bots/api#stopmessagelivelocation
func (b *Bot) StopMessageLiveLocation(ctx context.Context, params *StopMessageLiveLocationParams) (*types.Message, error) {
	return b.editMethodRequest(ctx, "stopMessageLiveLocation", params)
}

// SendVenue https://core.telegram.org/bots/api#sendvenue
func (b *Bot) SendVenue(ctx context.Context, params *SendVenueParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendContact(ctx context.Context, params *SendContactParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendPoll(ctx context.Context, params *SendPollParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendChecklist(ctx context.Context, params *SendChecklistParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SendDice(ctx context.Context, params *SendDiceParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) GetUserProfilePhotos(ctx context.Context, params *GetUserProfilePhotosParams) (*types.UserProfilePhotos, error) {
...
func (b *Bot) GetFile(ctx context.Context, params *GetFileParams) (*types.File, error) {
	result := &types.File{}
...
func (b *Bot) CreateChatInviteLink(ctx context.Context, params *CreateChatInviteLinkParams) (*types.ChatInviteLink, error) {
...
func (b *Bot) EditChatInviteLink(ctx context.Context, params *EditChatInviteLinkParams) (*types.ChatInviteLink, error) {
	result := &types.ChatInviteLink{}
...
func (b *Bot) CreateChatSubscriptionInviteLink(ctx context.Context, params *CreateChatSubscriptionInviteLinkParams) (*types.ChatInviteLink, error) {
	result := &types.ChatInviteLink{}
...
func (b *Bot) EditChatSubscriptionInviteLink(ctx context.Context, params *EditChatSubscriptionInviteLinkParams) (*types.ChatInviteLink, error) {
	result := &types.ChatInviteLink{}
...
func (b *Bot) RevokeChatInviteLink(ctx context.Context, params *RevokeChatInviteLinkParams) (*types.ChatInviteLink, error) {
	result := &types.ChatInviteLink{}
...
func (b *Bot) GetChat(ctx context.Context, params *GetChatParams) (*types.ChatFullInfo, error) {
	var result *types.ChatFullInfo
	err := b.rawRequest(ctx, "getChat", params, &result)
	return result, err
}

// GetChatAdministrators https://core.telegram.org/bots/api#getchatadministrators
func (b *Bot) GetChatAdministrators(ctx context.Context, params *GetChatAdministratorsParams) ([]types.ChatMember, error) {
...
func (b *Bot) GetChatMember(ctx context.Context, params *GetChatMemberParams) (*types.ChatMember, error) {
	result := &types.ChatMember{}
...
func (b *Bot) CreateForumTopic(ctx context.Context, params *CreateForumTopicParams) (*types.ForumTopic, error) {
	result := &types.ForumTopic{}
...
func (b *Bot) GetUserChatBoosts(ctx context.Context, params *GetUserChatBoostsParams) (*types.UserChatBoosts, error) {
	result := &types.UserChatBoosts{}
...
func (b *Bot) GetBusinessConnection(ctx context.Context, params *GetBusinessConnectionParams) (*types.BusinessConnection, error) {
	result := &types.BusinessConnection{}
...
func (b *Bot) GetMyCommands(ctx context.Context, params *GetMyCommandsParams) ([]types.BotCommand, error) {
...
func (b *Bot) GetMyName(ctx context.Context, params *GetMyNameParams) (types.BotName, error) {
...
func (b *Bot) GetMyDescription(ctx context.Context, params *GetMyDescriptionParams) (types.BotDescription, error) {
...
func (b *Bot) GetMyShortDescription(ctx context.Context, params *GetMyShortDescriptionParams) (types.BotShortDescription, error) {
...
func (b *Bot) GetChatMenuButton(ctx context.Context, params *GetChatMenuButtonParams) (types.MenuButton, error) {
...
func (b *Bot) GetMyDefaultAdministratorRights(ctx context.Context, params *GetMyDefaultAdministratorRightsParams) (*types.ChatAdministratorRights, error) {
...
func (b *Bot) EditMessageCaption(ctx context.Context, params *EditMessageCaptionParams) (*types.Message, error) {
...
func (b *Bot) EditMessageMedia(ctx context.Context, params *EditMessageMediaParams) (*types.Message, error) {
...
func (b *Bot) EditMessageChecklist(ctx context.Context, params *EditMessageChecklistParams) (*types.Message, error) {
	return b.editMethodRequest(ctx, "editMessageChecklist", params)
}

// EditMessageReplyMarkup https://core.telegram.org/bots/api#editmessagereplymarkup
func (b *Bot) EditMessageReplyMarkup(ctx context.Context, params *EditMessageReplyMarkupParams) (*types.Message, error) {
	return b.editMethodRequest(ctx, "editMessageReplyMarkup", params)
}

// StopPoll https://core.telegram.org/bots/api#stoppoll
func (b *Bot) StopPoll(ctx context.Context, params *StopPollParams) (*types.Poll, error) {
	result := &types.Poll{}
...
func (b *Bot) SendSticker(ctx context.Context, params *SendStickerParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) GetStickerSet(ctx context.Context, params *GetStickerSetParams) (*types.StickerSet, error) {
	result := &types.StickerSet{}
...
func (b *Bot) GetCustomEmojiStickers(ctx context.Context, params *GetCustomEmojiStickersParams) ([]*types.Sticker, error) {
	var result []*types.Sticker
...
func (b *Bot) UploadStickerFile(ctx context.Context, params *UploadStickerFileParams) (*types.File, error) {
	result := &types.File{}
...
func (b *Bot) AnswerWebAppQuery(ctx context.Context, params *AnswerWebAppQueryParams) (*types.SentWebAppMessage, error) {
	result := &types.SentWebAppMessage{}
...
func (b *Bot) SavePreparedInlineMessage(ctx context.Context, params *SavePreparedInlineMessageParams) (*types.PreparedInlineMessage, error) {
	result := &types.PreparedInlineMessage{}
	err := b.rawRequest(ctx, "savePreparedInlineMessage", params, result)
	return result, err
}

// SendInvoice https://core.telegram.org/bots/api#sendinvoice
func (b *Bot) SendInvoice(ctx context.Context, params *SendInvoiceParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) GetMyStarBalance(ctx context.Context) (*types.StarAmount, error) {
	result := types.StarAmount{}
	err := b.rawRequest(ctx, "getMyStarBalance", nil, &result)
	return &result, err
}

// GetStarTransactions https://core.telegram.org/bots/api#getstartransactions
func (b *Bot) GetStarTransactions(ctx context.Context, params *GetStarTransactionsParams) (*types.StarTransactions, error) {
	result := types.StarTransactions{}
...
func (b *Bot) SendGame(ctx context.Context, params *SendGameParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) SetGameScore(ctx context.Context, params *SetGameScoreParams) (*types.Message, error) {
	result := &types.Message{}
...
func (b *Bot) GetGameHighScores(ctx context.Context, params *GetGameHighScoresParams) ([]*types.GameHighScore, error) {
	var result []*types.GameHighScore
...
func (b *Bot) GetBusinessAccountStarBalance(ctx context.Context, params *GetBusinessAccountStarBalanceParams) (*types.StarAmount, error) {
	result := &types.StarAmount{}
...
func (b *Bot) GetBusinessAccountGifts(ctx context.Context, params *GetBusinessAccountGiftsParams) (*types.OwnedGifts, error) {
	result := &types.OwnedGifts{}
...
func (b *Bot) PostStory(ctx context.Context, params *PostStoryParams) (*types.Story, error) {
	result := &types.Story{}
...
func (b *Bot) EditStory(ctx context.Context, params *EditStoryParams) (*types.Story, error) {
	result := &types.Story{}
...
func (b *Bot) GetUserGifts(ctx context.Context, params *GetUserGiftsParams) (*types.OwnedGifts, error) {
	result := &types.OwnedGifts{}
...
func (b *Bot) GetChatGifts(ctx context.Context, params *GetChatGiftsParams) (*types.OwnedGifts, error) {
	result := &types.OwnedGifts{}
...
func (b *Bot) RepostStory(ctx context.Context, params *RepostStoryParams) (*types.Story, error) {
	result := &types.Story{}
...
func (b *Bot) GetUserProfileAudios(ctx context.Context, params *GetUserProfileAudiosParams) (*types.UserProfileAudios, error) {
	result := &types.UserProfileAudios{}
...
func (b *Bot) editMethodRequest(ctx context.Context, method string, params any) (*types.Message, error) {
