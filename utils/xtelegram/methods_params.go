...
type SendAudioParams struct {
	...
	MessageThreadID         int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID   int64                          `json:"direct_messages_topic_id,omitempty"`
	Audio                   types.InputFile                `json:"audio"`
	Caption                 string                         `json:"caption,omitempty"`
	ParseMode               types.ParseMode                `json:"parse_mode,omitempty"`
	CaptionEntities         []types.MessageEntity          `json:"caption_entities,omitempty"`
...
type SendDocumentParams struct {
	...
	MessageThreadID             int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID       int64                          `json:"direct_messages_topic_id,omitempty"`
	Document                    types.InputFile                `json:"document"`
	Thumbnail                   types.InputFile                `json:"thumbnail,omitempty"`
	Caption                     string                         `json:"caption,omitempty"`
	ParseMode                   types.ParseMode                `json:"parse_mode,omitempty"`
	CaptionEntities             []types.MessageEntity          `json:"caption_entities,omitempty"`
...
type SendVideoParams struct {
	...
	MessageThreadID         int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID   int64                          `json:"direct_messages_topic_id,omitempty"`
	Video                   types.InputFile                `json:"video"`
	Duration                int64                          `json:"duration,omitempty"`
...
type SendAnimationParams struct {
	...
	MessageThreadID         int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID   int64                          `json:"direct_messages_topic_id,omitempty"`
	Animation               types.InputFile                `json:"animation"`
	Duration                int64                          `json:"duration,omitempty"`
	Width                   int                            `json:"width,omitempty"`
	Height                  int                            `json:"height,omitempty"`
	Thumbnail               types.InputFile                `json:"thumbnail,omitempty"`
...
type SendVoiceParams struct {
	...
	MessageThreadID         int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID   int64                          `json:"direct_messages_topic_id,omitempty"`
	Voice                   types.InputFile                `json:"voice"`
	Caption                 string                         `json:"caption,omitempty"`
	ParseMode               types.ParseMode                `json:"parse_mode,omitempty"`
	CaptionEntities         []types.MessageEntity          `json:"caption_entities,omitempty"`
	Duration                int64                          `json:"duration,omitempty"`
...
type SendVideoNoteParams struct {
	...
	MessageThreadID         int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID   int64                          `json:"direct_messages_topic_id,omitempty"`
	VideoNote               types.InputFile                `json:"video_note"`
	Duration                int64                          `json:"duration,omitempty"`
...
type SetChatMenuButtonParams struct {
	ChatID     any                   `json:"chat_id,omitempty"`
	MenuButton types.InputMenuButton `json:"menu_button"`
}
...
type SendStickerParams struct {
	...
	MessageThreadID         int64                          `json:"message_thread_id,omitempty"`
	DirectMessagesTopicID   int64                          `json:"direct_messages_topic_id,omitempty"`
	Sticker                 types.InputFile                `json:"sticker"`
	Emoji                   string                         `json:"emoji,omitempty"`
	DisableNotification     bool                           `json:"disable_notification,omitempty"`
	ProtectContent          bool                           `json:"protect_content,omitempty"`
	AllowPaidBroadcast      bool                           `json:"allow_paid_broadcast,omitempty"`
