...
func addFormFieldInputFileUpload(form *multipart.Writer, fieldName string, value *types.InputFileUpload) error {
...
func addFormFieldInlineQueryResultSlice(form *multipart.Writer, fieldName string, value []types.InlineQueryResult) error {
	var lines []string
	for _, media := range value {
...
func addFormFieldInputStickerSlice(form *multipart.Writer, fieldName string, value []types.InputSticker) error {
	var lines []string
